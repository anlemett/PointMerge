...
DATASET_DATA_DIR = os.path.join(DATA_DIR, "Dataset") # to save fligh ids for PM dataset
if not os.path.exists(DATASET_DATA_DIR):
    os.makedirs(DATASET_DATA_DIR)

DATA_DIR = os.path.join(DATA_DIR, "PIs")

def calculate_vfe_by_hour(month, week):
    input_filename = "PIs_vertical_by_flight_2019_10_week" + str(week) + "_rwy28L.csv"
    output_filename = "PIs_vertical_by_hour_2019_10_week" + str(week) + "_rwy28L.csv"


    #flight_id begin_date end_date begin_hour end_hour number_of_levels time_on_levels time_on_levels_percent
    ...
    print(os.path.join(DATA_DIR, output_filename))
    ...
    filename = "week" + str(week) + "_50NM_more_than_25_flights_per_hour_flight_ids.txt"
...
def main():
    ...
    for week in range (0,5):
        calculate_vfe_by_hour(10, week+1)
