...
def calculate_vfe(month, week):
    ...
    DATA_INPUT_DIR = os.path.join(DATA_DIR, "osn_ESSA_states_50NM_2019")
    DATA_INPUT_DIR = os.path.join(DATA_INPUT_DIR, "osn_ESSA_states_50NM_2019_10_week" + str(week) + "_by_runways")

    input_filename = "osn_"+ airport_icao + "_states_50NM_" + year + '_' + str(month) + "_week" + str(week) + "_rwy01R.csv"
