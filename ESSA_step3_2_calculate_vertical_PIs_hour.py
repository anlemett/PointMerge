...
def calculate_vfe_hour(month, week):
    input_filename = "PIs_vertical_by_flight_2019_" + str(month) + "_week" + str(week) + "_rwy01R.csv"
    output_filename = "PIs_vertical_by_hour_2019_" + str(month) + "_week" + str(week) + "_rwy01R.csv"
    ...
    filename = "ESSA_2019_10_week" + str(week) + "more_than_25_flight_ids.txt"
